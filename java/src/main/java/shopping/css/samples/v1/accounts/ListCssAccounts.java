...
/**
 * This class demonstrates how to list the child (CSS domain) Accounts of a given CSS group Account
 */
public class ListCssAccounts {
  ...
  public static void listCssAccounts(Config config) throws Exception {
    ...
    String parent = getParent(config.getGroupId().toString());
